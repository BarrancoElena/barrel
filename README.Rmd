---
title: "barrel: Ordination visualization in R"
...
[![CRAN status](https://www.r-pkg.org/badges/version/barrel)](https://CRAN.R-project.org/package=barrel)
[![R-CMD-check](https://github.com/YOUR_USERNAME/barrel/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/YOUR_USERNAME/barrel/actions)
...
devtools::install_github("YOUR_USERNAME/barrel")
```
...
👉 [View vignette online](https://yourwebsite.com/barrel/articles/Visualizing-Ordinations.html)
...
[@yourhandle](https://github.com/YOUR_USERNAME)
